...
HD_PWD='C:/Users/kyha/Downloads/lab9_pl_camera_verilog/lab9_pl_camera_verilog.runs/ram_camera_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_camera.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_camera.tcl
